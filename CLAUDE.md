...
3. For a new project, update `project_contract.json` before changing cells or assembly; never free-draw in EasyEDA for delivery.
4. Run `npm.cmd run contract`, then `npm.cmd run accept`.
