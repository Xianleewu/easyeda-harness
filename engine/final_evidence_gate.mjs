...
const local = {
	...
	projectGeometry: requireReportPass(findings, 'project_geometry_report.json', 'project geometry report'),
...
for (const [rel, label, report] of [
	...
	['project_geometry_report.json', 'project geometry report', local.projectGeometry],
